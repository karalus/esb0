...
<%
			if (globalContext.getHttpGlobalContext().getCookieManager() != null) {
				for (java.net.HttpCookie httpCookie : globalContext.getHttpGlobalContext().getCookieManager().getCookieStore().getCookies()) {
					%>
