...
public abstract class AbstractServiceArtifact extends Artifact {
	...
	static {
		...
		try (InputStream inputStream = AbstractServiceArtifact.class.getClassLoader().getResourceAsStream("service.v01.xsd")) {
	...
	protected <S extends Object> S unmarshal() throws JAXBException {
